...
describe("Certificate", function()
    ...
    describe("set_pem_cert", function()
        ...
        it("successfully sets the PEM encoded certificate", function()
            ...
            local set_cert_err = certificate.set_pem_cert(mock_cert)
            ...
            assert.is_not_truthy(set_cert_err)
        end)
    end)
    ...
    describe("set_pem_priv_key", function()
        ...
        it("successfully sets the PEM encoded private key", function()
            ...
            local set_priv_key_err = certificate.set_pem_priv_key(mock_priv_key)
            ...
            assert.is_not_truthy(set_priv_key_err)
        end)
    end)
end)
